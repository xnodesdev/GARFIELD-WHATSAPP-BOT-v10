...
if (body.toLowerCase().includes('good morning') || body.toLowerCase().includes('gm')) {
    // Generate TTS voice message
    const ttsText = `good morning  ${pushname}`;
    const ttsUrl = googleTTS.getAudioUrl(ttsText, {
        lang: 'en',
        slow: false,
        host: 'https://translate.google.com',
...
if (body.toLowerCase().includes('good night') || body.toLowerCase().includes('gn')) {
    // Generate TTS voice message
    const ttsText = `good night ${pushname}`;
    const ttsUrl = googleTTS.getAudioUrl(ttsText, {
        lang: 'en',
        slow: false,
        host: 'https://translate.google.com',
...
if (body.toLowerCase().includes('good evening') || body.toLowerCase().includes('ge')) {
    // Generate TTS voice message
    const ttsText = `good evening ${pushname}.`;
    const ttsUrl = googleTTS.getAudioUrl(ttsText, {
        lang: 'en',
        slow: false,
        host: 'https://translate.google.com',
